...
var red_lowpass = naip_red.gt(198).clip(test_site_02);
...
/// create buffer around us points  ///
...
// var polys = ee.FeatureCollection(mobile_polys_02_red);

// var polyList = polys.toList(polys.size());

// var polyIntersect = db_buffer.iterate(function(feature, list){
//   list = ee.List(list);
//   feature = ee.Feature(feature);

//   var intersection = polyList.map(function(feat) {
